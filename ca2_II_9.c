...
/**************************zero phase*******************************
	for(k=0;k<image_size;k++){
		for(m=0;m<image_size;m++){
			float mag2 = sqrt((image_complex[k][m].real*image_complex[k][m].real)+(image_complex[k][m].imag*image_complex[k][m].imag));			
			image_complex[k][m].real = mag2;
			image_complex[k][m].imag = 0;
...
/**************************autocorrelation************************************/
	for(k=0;k<image_size;k++){
		for(m=0;m<image_size;m++){
			float mag_sq = (image_complex[k][m].real*image_complex[k][m].real)+(image_complex[k][m].imag*image_complex[k][m].imag); 			
			image_complex[k][m].real = mag_sq;
			image_complex[k][m].imag = 0;
...
/*************************find non zero pixels*********************************/
	...
	for(k=0;k<image_size;k++){
		for(m=0;m<image_size;m++){
			if(image_float[k][m]>(max_value/10000)) {count++;}
		}
	}
